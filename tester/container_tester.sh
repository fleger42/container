...
function compil()
{
	...
	clang++ $1 -D ACCESS=std -Wall -Werror -Wextra -std=c++98 -g -fsanitize=address -o std_container
	clang++ $1 -D ACCESS=ft -Wall -Werror -Wextra -std=c++98 -g -fsanitize=address -o ft_container
